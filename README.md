...
(I dove into the Nintendo character rather than the vacuum)
...
1. Train Bert base models like MobileBert and fine-tune LLMs like Mistral-Nemo and Meta Llama models.
1. Put these models into a production environment based on specific throughput requirements, full CICD, and monitoring and evaluations.
